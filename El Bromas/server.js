...
const MP_UI = `<div id="mpOnlineHud" style="position:fixed;right:12px;top:12px;z-index:99999;display:flex;align-items:center;gap:7px;font-family:Arial,sans-serif;pointer-events:auto"><button id="mpOnlineBtn" type="button" style="height:38px;padding:0 14px;border:2px solid #39ff88;border-radius:19px;background:rgba(0,0,0,.78);color:#fff;font-weight:900;font-size:14px;box-shadow:0 0 12px rgba(57,255,136,.35);touch-action:manipulation">ONLINE</button><span id="mpOnlineCount" style="display:none;min-width:38px;text-align:center;padding:7px 9px;border-radius:14px;background:rgba(0,0,0,.78);color:#39ff88;font-weight:900;font-size:13px">0</span></div>`;
