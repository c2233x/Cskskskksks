...
fs.readFileSync=function(file,enc){
 ...
 if(typeof out==='string'&&/Salva a cornatan .*\.html$/.test(name)){
  ...
  const tag='<script src="/online-final14.js?v=14"></script><script src="/online-final18.js?v=26"></script><script src="/online-final17.js?v=24"></script><script src="/online-final24.js?v=3"></script><script src="/online-final25.js?v=2"></script>';
